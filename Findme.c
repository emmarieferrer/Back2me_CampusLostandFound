...
/* ================================================
   ...
   2. Define empty set N
   3. Label source with 0, insert into N
   4. Repeat until no labelled nodes remain outside N:
   5.   Consider neighbours of newly inserted node NOT in N
   6a.  No label yet:   label = dist[u] + edge weight
   6b.  Already labelled: label = MIN(current, dist[u] + edge)
   7.   Pick smallest labelled node outside N, add to N
   ================================================ */
void dijkstra(int src) {

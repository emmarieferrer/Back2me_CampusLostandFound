...
# Overview 
Back2me is a console-based campus lost and found system that runs entirely in the terminal/command prompt. It provides a text-based interface for students, faculty, and staff to report lost and found item, view, search, mark item as claimed, process claim, find route and exit the system.
